...
class BodyEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create body_entry" do
    assert_difference("BodyEntry.count") do
      post body_entries_url, params: { body_entry: { diary_id: @body_entry.diary_id, fat_mass: @body_entry.fat_mass, height: @body_entry.height, muscle_mass: @body_entry.muscle_mass, note: @body_entry.note, weight: @body_entry.weight } }
    end
  ...
  test "should update body_entry" do
    patch body_entry_url(@body_entry), params: { body_entry: { diary_id: @body_entry.diary_id, fat_mass: @body_entry.fat_mass, height: @body_entry.height, muscle_mass: @body_entry.muscle_mass, note: @body_entry.note, weight: @body_entry.weight } }
